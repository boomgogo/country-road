...
for (const v of variants) {
  ...
  const out = await b.evaluate(`new Promise((resolve) => {
    ...
    wrapM(P.ink.quad, 'render', 'ink', null); wrapM(P.grade.quad, 'render', 'grade', null); wrapM(P.fxaa.quad, 'render', 'fxaa', null);
